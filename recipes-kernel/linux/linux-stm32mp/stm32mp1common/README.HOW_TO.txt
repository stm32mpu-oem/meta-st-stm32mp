...
Update Starter Package bootfs with new generated dtb and uImage
* kernel + devicetree:
    #> mkdir -p <your_starter_package_dir_path>/bootfs_mounted
    #> sudo mount -o loop <your_starter_package_dir_path>/images/stm32mp1/st-image-bootfs-openstlinux-weston-stm32mp1.ext4 <your_starter_package_dir_path>/bootfs_mounted
    #> sudo cp -vf ${OUTPUT_BUILD_DIR}/install_artifact/boot/uImage  <your_starter_package_dir_path>/bootfs_mounted/
